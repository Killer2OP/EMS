...
<p class="m-0 label">All complaints assigned to you</p>
    ...
    <div class="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
      <div class="table-search-bar">
        ...
        <div class="relative inline-block w-full align-middle" style="max-width: 160px;"><select class="w-full px-3.5 py-2.5 border-[1.5px] border-input-border rounded-lg text-[0.85rem] text-input-text bg-input-bg outline-none transition-colors focus:border-[#0066CC] focus:ring-[3px] focus:ring-[#0066CC]/10 dark:focus:border-blue-500 dark:focus:ring-blue-500/20 appearance-none pr-9" style="max-width: 160px;" [(ngModel)]="statusFilter" (ngModelChange)="filter()">
